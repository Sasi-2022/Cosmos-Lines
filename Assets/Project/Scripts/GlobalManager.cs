...
public class GlobalManager
{
    ...
    public FaceBookLoginManager faceBookLogin { get; private set; }
    ...
    public void InitializeFacebookLogin()
    {
        if (faceBookLogin == null)
        {
            ...
            if (fbLoginObject == null)
            {
                ...
                faceBookLogin = fbLoginObject.AddComponent<FaceBookLoginManager>();
                Object.DontDestroyOnLoad(fbLoginObject);
                Debug.Log("FaceBookLogin instance created and added to DontDestroyOnLoad.");
            }
            else
            {
                faceBookLogin = fbLoginObject.GetComponent<FaceBookLoginManager>();
